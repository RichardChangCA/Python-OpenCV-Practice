...
#add hidden layer
l1 = add_layer(xs, 1, 10, n_layer=1, activation_function=tf.nn.relu)  # 输入1个神经元，输出10个神经元，relu激活函数
#add output layer
prediction = add_layer(l1, 10, 1, n_layer=2, activation_function=None)  # 假设隐藏层有10个神经元
